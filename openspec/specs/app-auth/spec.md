...
Quién puede entrar en la aplicación y cómo lo demuestra: el operador único sembrado desde
el entorno, la sesión que viaja en cookie, qué rutas la exigen, cómo se vuelve al destino
pedido, qué se responde ante credenciales erróneas o repetidas, y cómo se cierra. No cubre
quién puede ver qué dato una vez dentro —no hay modelo de permisos— ni el render del
documento.
