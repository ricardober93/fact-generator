# boosted-nav-cache Specification

## Purpose

Cómo se versiona una vista parametrizada bajo navegación boosted: qué entradas debe recoger
su clave, qué garantía da —nunca servir contenido viejo—, hacia qué lado puede equivocarse y
qué pasa cuando la clave se queda corta. No cubre el render de las páginas ni la caché del
navegador para recursos estáticos.
